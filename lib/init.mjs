...
export function printInitSummary(result) {
  ...
  console.log('')
  console.log('  Hook: confirm (default) — Read util + AGENTS; sameTurnAllow true (single-turn Confirm→Write)')
  console.log('  Default hookMode: confirm. Set off in .utils-bookrc.json for Rules-only; sameTurnAllow: false for strict audit.')
  console.log('')
