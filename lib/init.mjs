...
export function patchHooksJson(projectRoot, templatesRoot, force) {
...
export function runInit(cwd, options = {}) {
  ...
  const hooksPath = patchHooksJson(projectRoot, templatesRoot, true)
...
export function printInitSummary(result) {
  ...
  console.log('  3. Optional CI: pnpm check:utils-book (commit utils-book + utils-index first)')
  console.log('')
}
