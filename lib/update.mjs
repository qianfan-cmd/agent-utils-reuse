...
export function printStatusSummary(result) {
  ...
  if (gateDrift === true) {
    ...
    console.log('  State: node_modules newer than stamp — run: pnpm update:utils-reuse')
  } else if (stampedVersion && nodeModulesVersion && stampedVersion !== nodeModulesVersion) {
    console.log('  State: version stamp differs from node_modules — run: pnpm update:utils-reuse')
  ...
  console.log('')
  console.log('  Tip: agent-utils-reuse verify — detailed gate file check')
  console.log('')
}
