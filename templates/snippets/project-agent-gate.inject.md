...
- **Read util ≠ gate complete.** **Message A** (no Write): Discovery (when triggered) + **Local helpers** table + **Confirm (Q1–Q4 per symbol, separately)** + **`Verdict（最终）`**. **Message B**: Write.
